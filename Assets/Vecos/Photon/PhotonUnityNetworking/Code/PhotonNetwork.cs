...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        public static void LoadLevel(string levelName)
        {
            ...
            //PhotonNetwork.IsMessageQueueRunning = false;
            //loadingLevelAndPausedNetwork = true;
            //Debug.LogError("Scene is now loading with photon hjehhehe");
            //AddressablesLoader.Instance.LoadAddressableScene(levelName, () =>
            //{
            ...
            //_AsyncLevelLoadingOperation.completed += (AsyncOperation a) =>
            //{
            //     loadingLevelAndPausedNetwork = false;
            //    PhotonNetwork.IsMessageQueueRunning = true;
            //};
